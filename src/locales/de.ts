...
const de: PartialLocaleType = {
  ...
  Settings: {
    ...
    Actions: {
      ...
      Close: 'Schließen',
      ConfirmResetAll: 'Möchten Sie wirklich alle Konfigurationen zurücksetzen?',
  ...
  Store: {
    ...
    Prompt: {
      History: (content: string) =>
        'Dies ist eine Zusammenfassung des Chatverlaufs zwischen dem KI und dem Benutzer als Rückblick: ' + content,
      Topic:
