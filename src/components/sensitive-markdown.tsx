...
export function PreCode(props: {children: any}) {
  ...
  return (
    <>
      ...
      <pre
        className='relative text-xs p-2.5 py-4 bg-content-grey-900 rounded-[6px] overflow-auto [&>*]:whitespace-pre-wrap [&>*]:break-words'
        ref={ref}
      >
        <span
...
export const SensitiveMarkdownContent = React.memo(_SensitiveMarkDownContent);

export function SensitiveMarkdown(
  props: {
    content: string;
    loading?: boolean;
    fontSize?: number;
