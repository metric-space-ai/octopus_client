  ...
  persist(
    (set, get) => ({
      ...
      async onUserInput(content) {
        ...
        api.llm.chat({
          ...
          onController(controller) {
            ...
            ChatControllerPool.addController(sessionIndex, botMessage.id ?? messageIndex, controller);
          },
        });
      },
      ...
      getMessagesWithMemory() {
        ...
        const memoryStartIndex = Math.min(longTermMemoryStartIndex, shortTermMemoryStartIndex);
        ...
        // concat all messages
        const recentMessages = [...longTermMemoryPrompts, ...contextPrompts, ...reversedRecentMessages.reverse()];
