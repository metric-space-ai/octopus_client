export const RightPanel = () => (
  <div className='relative px-20 flex flex-col items-center justify-center bg-auth-background bg-no-repeat bg-cover rounded-[20px]'>
    ...
    <div className='absolute bottom-10 flex flex-col sm:flex-row gap-4'>
      <div className='text-xs font-semibold text-content-white text-center border border-content-white rounded-[32px] px-5 py-2'>
        Increased Efficiency
      </div>
      <div className='text-xs font-semibold text-content-white border border-content-white rounded-[32px] px-5 py-2'>
